...
export const DEPLOY = [
  ...
  },
  {
    ...
    badge: "No clone",
    body: "Use a versioned container when your release process publishes one; verify the image digest and model provenance before production use.",
    code: ["docker run --rm -p 8000:8000 \\", "  ghcr.io/sachncs/redax:<version>"],
  },
  {
    title: "From source",
    badge: "Dev-friendly",
